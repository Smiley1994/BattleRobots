//
//  ANN9FreeVideoViewController.swift
//  BattleRobots
//
...
class ANN9FreeVideoViewController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func requestData(offset : NSInteger) {
        page = offset + 10
        ANN9RequestManager.requestData(Ann9FreeVideoList, parameterJson: "{\"offset\":\(offset),\"limit\":\(pageSize)}", success: { (json) in
